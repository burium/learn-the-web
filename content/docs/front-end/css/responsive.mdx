...
You've learned about [CSS layout](./layout) and how to structure your web pages. But in today's world, websites need to look good and work well on _all_ devices, from giant desktop monitors to tiny smartphone screens. That's where **responsive design** comes in. Responsive design is the practice of creating web pages that adapt to different screen sizes, orientations, and resolutions, providing an optimal viewing experience for every user.
